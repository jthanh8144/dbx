...
export default withEnglishFallback({
  ...
  settings: {
    ...
    iconThemeBlackDescription: "Usa el logo negro dentro de la aplicación. En macOS, el Dock conserva la marca de color sobre un fondo negro y la barra de menús sigue la apariencia del sistema.",
